    ...
    <>
      ...
      <div className={styles['card']}>
        ...
        <div className={styles['order']}>
          <div className={styles['order-item']}>
            <img src='/src/assets/images/order1.png' className={styles['order-image']} />
            <div>待付款</div>
          </div>
          <div className={styles['order-item']}>
            <img src='/src/assets/images/order2.png' className={styles['order-image']} />
            <div>待发货</div>
          </div>
          <div className={styles['order-item']}>
            <img src='/src/assets/images/order3.png' className={styles['order-image']} />
            <div>待收货</div>
          </div>
          <div className={styles['order-item']}>
            <img src='/src/assets/images/order4.png' className={styles['order-image']} />
            <div>待评价</div>
          </div>
          <div className={styles['order-item']}>
            <img src='/src/assets/images/order5.png' className={styles['order-image']} />
            <div>退款/售后</div>
          </div>
        </div>
      </div>
      ...
      <div className={styles['card']}>
        ...
        <div className={styles['navigation']}>
          ...
          <div className={styles['navigation-item']}>
            <img src='/src/assets/images/service.png' className={styles['navigation-image']} />
            <div>客服中心</div>
          </div>
        </div>
      </div>
