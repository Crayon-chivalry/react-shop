...
import { MoreOutline, AppstoreOutline, TruckOutline, RightOutline, CheckShieldOutline } from 'antd-mobile-icons'
    ...
    <>
      ...
      <div id="section-1">
        <Swiper indicatorProps={{ color: "white" }}>
          <Swiper.Item>
            <img src="/src/assets/images/goods/SK-II.jpg" className={styles['swiper-image']} />
          </Swiper.Item>
        </Swiper>
      </div>
